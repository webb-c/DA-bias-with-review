...
def combine_each() :
    read_folder_path = 'C:/Users/CoIn240/PycharmProjects/DA/data/preprocessing'
    ...
    combined_Y.to_csv("C:/Users/CoIn240/PycharmProjects/DA/data/dataset/dataset_Y.csv", encoding='utf-8-sig')
    combined_N.to_csv("C:/Users/CoIn240/PycharmProjects/DA/data/dataset/dataset_N.csv", encoding='utf-8-sig')

def combine_all() :
    read_folder_path = 'C:/Users/CoIn240/PycharmProjects/DA/data/dataset'
    ...
    combined.to_csv("C:/Users/CoIn240/PycharmProjects/DA/data/dataset/dataset_All.csv", encoding='utf-8-sig')
